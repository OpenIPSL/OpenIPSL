...
model GridEquivalentConstantVoltageSource2
...
Modelica.Blocks.Interfaces.RealOutput OUT1
  ...
  Modelica.Blocks.Interfaces.RealOutput OUT4
    ...
    annotation (Placement(transformation(extent={{140,0},{160,20}})));
         Modelica.Blocks.Interfaces.RealOutput OUT7 annotation (Placement(transformation(extent={{140,-20},{160,0}})));
  ...
  Modelica.Blocks.Sources.Constant VI1(k=-0.00980921) if equivalentInfBUS
    annotation (Placement(transformation(extent={{114,90},{104,100}})));
     ...
     Modelica.Blocks.Interfaces.RealOutput OUT8 annotation (Placement(transformation(extent={{140,-40}, {160,-20}})));
  ...
  PFData.PowerFlow powerFlow(redeclare record PowerFlow =
        OpenIPSL.Examples.MPC.PFData.PF10)
  ...
  Electrical.Loads.PSSE.Load_variation Load3(
    V_b=220000,
    P_0=0,
    Q_0=0,
    v_0=powerFlow.powerflow.bus.V6,
...
equation
  ...
  connect(Load3.p, B6.p) annotation (Line(points={{28,-20},{50,-20},{50,-20},{60,
          -20}}, color={0,0,255}));
...
end GridEquivalentConstantVoltageSource2;
