...
model FINAL_SYSTEM_REDUCED_OUTPUTS
...
Modelica.Blocks.Interfaces.RealOutput OUT1
  ...
  //Modelica.Blocks.Interfaces.RealOutput OUT4
   // annotation (Placement(transformation(extent={{140,-2},{160,18}})));
     ...
     //Modelica.Blocks.Interfaces.RealOutput OUT7 annotation (Placement(transformation(extent={{140,-62},{160,-42}})));

     //Modelica.Blocks.Interfaces.RealOutput OUT8 annotation (Placement(transformation(extent={{140,-82}, {160,-62}})));
...
end FINAL_SYSTEM_REDUCED_OUTPUTS;
