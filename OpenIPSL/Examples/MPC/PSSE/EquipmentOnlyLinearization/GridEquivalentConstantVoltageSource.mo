...
model GridEquivalentConstantVoltageSource
...
Modelica.Blocks.Interfaces.RealOutput OUT1
  ...
  Modelica.Blocks.Interfaces.RealOutput OUT4
    ...
    annotation (Placement(transformation(extent={{140,0},{160,20}})));
         Modelica.Blocks.Interfaces.RealOutput OUT7 annotation (Placement(transformation(extent={{140,-20},
            {160,0}})));
  ...
  Modelica.Blocks.Sources.Constant VI1(k=-0.00980921) if equivalentInfBUS
    annotation (Placement(transformation(extent={{114,90},{104,100}})));
     ...
     Modelica.Blocks.Interfaces.RealOutput OUT8 annotation (Placement(transformation(extent={{140,-40},
            {160,-20}})));
         Modelica.Blocks.Interfaces.RealOutput OUT9 annotation (Placement(transformation(extent={{140,-60},
            {160,-40}})));
     Modelica.Blocks.Interfaces.RealOutput OUT10 annotation (Placement(transformation(extent={{140,-80},
            {160,-60}})));
...
end GridEquivalentConstantVoltageSource;
