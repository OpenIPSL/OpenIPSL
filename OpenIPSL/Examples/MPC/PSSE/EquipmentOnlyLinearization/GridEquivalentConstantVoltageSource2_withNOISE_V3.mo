...
model GridEquivalentConstantVoltageSource2_withNOISE_V3
...
equation
  ...
  connect(Load3.p, B6.p)
    annotation (Line(points={{30,-20},{60,-20}}, color={0,0,255}));
  connect(IN11.y, G2.P_ref1)
    annotation (Line(points={{-99,-60},{54,-60},{54,-52}}, color={0,0,127}));
  connect(IN22.y, G2.Efd_ref)
    annotation (Line(points={{-99,-100},{66,-100},{66,-52}}, color={0,0,127}));
...
end GridEquivalentConstantVoltageSource2_withNOISE_V3;
