...
model GridEquivalentConstantVoltageSource2_withNOISE_SANITYCHECK
...
equation
  ...
  connect(Load3.p, B6.p) annotation (Line(points={{53,-13},{54,-13},{54,-20},{
          60,-20}},
                 color={0,0,255}));
...
end GridEquivalentConstantVoltageSource2_withNOISE_SANITYCHECK;
