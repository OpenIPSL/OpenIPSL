...
model Network
  ...
  OpenIPSL.Electrical.Loads.PSSE.Load LD2(
    ...
    Q_0=12000000) annotation (Placement(transformation(extent={{94,-72},{106,-60}})));
  ...
  Electrical.Events.Breaker breaker(t_o=10)
                                           annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=90,
        origin={80,-8})));
...
equation
  ...
  connect(L2_2.p, B2.p) annotation (Line(points={{24.6,20},{4,20},{4,40},{0,40}},
        color={0,0,255}));
  connect(T2.p, B4.p) annotation (Line(points={{60,-35.4},{60,-24},{80,-24},{80,
          -20}},
        color={0,0,255}));
  ...
  connect(breaker.s, B4.p)
    annotation (Line(points={{80,-12},{80,-20}}, color={0,0,255}));
  connect(breaker.r, L3.n)
    annotation (Line(points={{80,-4},{80,4.6}}, color={0,0,255}));
  connect(T2.n, B5.p)
    annotation (Line(points={{60,-48.6},{60,-60}}, color={0,0,255}));
  connect(gain.y, G2.Padd) annotation (Line(points={{21,-90},{30,-90},{30,-106},
          {57.6,-106},{57.6,-92}}, color={0,0,127}));
