...
model CampusGridA_THESIS_GENCLS_ONLY "Microgrid model for university campus A"
...
equation
  ...
  connect(UTILITY.p, BreakerMicrogrid.r)
    annotation (Line(points={{-60,200},{0,200},{0,186}}, color={0,0,255}));
...
end CampusGridA_THESIS_GENCLS_ONLY;
