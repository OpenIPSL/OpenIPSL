...
partial record BusTemplate2
  ...
  parameter OpenIPSL.Types.PerUnit V14 "B14" annotation (Dialog(enable=false));
  parameter OpenIPSL.Types.Angle A14 "B14" annotation (Dialog(enable=false));
    parameter OpenIPSL.Types.PerUnit V15 "B15"
    annotation (Dialog(enable=false));
  parameter OpenIPSL.Types.Angle A15 "B15" annotation (Dialog(enable=false));
    parameter OpenIPSL.Types.PerUnit V16 "B16"
    annotation (Dialog(enable=false));
  parameter OpenIPSL.Types.Angle A16 "B16" annotation (Dialog(enable=false));
    parameter OpenIPSL.Types.PerUnit V17 "B17"
    annotation (Dialog(enable=false));
  parameter OpenIPSL.Types.Angle A17 "B17" annotation (Dialog(enable=false));
