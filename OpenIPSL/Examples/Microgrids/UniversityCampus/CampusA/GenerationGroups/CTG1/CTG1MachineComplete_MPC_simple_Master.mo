...
model CTG1MachineComplete_MPC_simple_Master
  ...
  Modelica.Blocks.Sources.BooleanExpression booleanExpression(y=if time < 2.6
...
equation
  ...
  connect(PI.y, switch1.u3) annotation (Line(points={{-9.5,85},{26,85},{26,75.2},
          {50.8,75.2}}, color={0,0,127}));
  connect(add1.y, PI.u)
    annotation (Line(points={{-29.5,85},{-21,85}}, color={0,0,127}));
...
end CTG1MachineComplete_MPC_simple_Master;
