...
model IEEE421Example
  ...
  Generation_Group.Generator1 generator1(
    ...
    enableangle_0=true,
    redeclare record GUnitDynamics = IEEE421.ST.ESST1A_1 (
          redeclare record ExcSystem = IEEE421.ES_Data.ST.ESST1A_1 (
            T_F=1,
            K_LR=1,
            I_LR=0)))          annotation (Placement(transformation(
