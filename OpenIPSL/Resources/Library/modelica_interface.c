...
__declspec(dllexport) int32_T __cdecl Model_Outputs(IEEE_Cigre_DLLInterface_Instance* instance) {
    ...
    */
    ...
    parameters->T2_POD = 0.001;
    parameters->POD_min = -0.5;
    parameters->POD_max = 0.5;
    parameters->Vdip = 0.8;
    parameters->Vup = 1.2;
    parameters->KpVdq = 3;
    parameters->KiVdq = 10;
...
__declspec(dllexport) void* __cdecl init_gfm_model(double c_filt, double r_filta, double l_filt, double r_l,
