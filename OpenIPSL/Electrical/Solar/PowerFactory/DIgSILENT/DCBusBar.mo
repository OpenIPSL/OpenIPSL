...
equation
  ...
  annotation (
    Icon(coordinateSystem(
        ...
        grid={2,2}), graphics={Rectangle(lineColor = {118, 18, 62},fillColor = {255, 255, 255},
            fillPattern =                                                                                     FillPattern.Solid, extent = {{-100, -100}, {100, 100}}),Text(origin = {-50, -38},
            fillPattern =                                                                                                                                                                                     FillPattern.Solid, extent = {{-29.23, -10}, {29.23, 10}}, textString = "P_conv", fontName = "Arial"),Text(origin = {-61.52, 42.04},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-20.9, -9.01}, {20.9, 9.01}}, textString = "I_pv", fontName = "Arial"),Text(origin = {82, 0},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-25.16, -9.47}, {25.16, 9.47}}, textString = "Udc", fontName = "Arial"), Line(points = {{6, 28}, {6, -28}}, color = {118, 18, 62}), Line(points = {{6, 0}, {38, 0}}, color = {118, 18, 62}), Line(points = {{-6, 28}, {-6, -28}}, color = {118, 18, 62}), Line(points = {{-40, 0}, {-6, 0}}, color = {118, 18, 62}), Text(origin = {0, -10}, lineColor = {0, 0, 255}, extent = {{-100, 150}, {100, 110}}, textString = "%name")}),
