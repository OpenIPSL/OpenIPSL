...
equation
  ...
  annotation (
    Icon(graphics={ Rectangle(
          ...
          extent={{-100,-100},{100,100}}), Text(origin = {-51.7, 80.01},
            fillPattern =                                                              FillPattern.Solid, extent = {{-20.3, -10.18}, {20.3, 10.18}}, textString = "id_ref", fontName = "Arial",
            horizontalAlignment =                                                                                                                                                                                     TextAlignment.Left), Text(origin = {-48.7, 39.82},
            fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-23.3, -10.18}, {23.3, 10.18}}, textString = "iq_ref", fontName = "Arial",
